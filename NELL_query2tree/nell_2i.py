...
# '''
q2b_path = '../../Q2Bdata/NELL/test_ans_3i.pkl'
...
for k, v in test_1_p.items():
    ...
    tree = ((set(tree0).union(set(tree_0)).intersection(set(tree1)).union(set(tree2)))).intersection(set(tree3).union(set(tree4)))
    # # # # print(tree)
    rr = []
    for a in list(v):
        try:
