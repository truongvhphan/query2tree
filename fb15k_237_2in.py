...
# nn = neigh.fit(data)
# with open(f'../FB15k_237_query2tree/fb15k_237_brute.pkl', 'wb') as kdfile:
...
with open('../FB15k_237_query2tree/fb15k_237_brute.pkl', 'rb') as file:
    nn = pickle.load(file)
...
# '''
q2b_path = '../../Q2Bdata/FB15k-237/test_ans_ic.pkl'
...
for k, v in test_1_p.items():
    ...
    # tree0_neg = set(ent_v).difference(set(tree0))
    ...
    tree = set(tree0).intersection(tree1_neg)
    # # print(tree)
    rr = []
    for a in list(v):
        try:
...
with open('../FB15k_237_query2tree/fb15k_237_pin.pkl', 'wb') as f:
