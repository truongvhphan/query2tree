...
path = '../FB15k_237_query2tree/fb15k_237_graph.pkl'
ent2id_path = '../FB15k-237/entities.txt'
relation2id_path = '../FB15k-237/relations.txt'
train_path = '../FB15k-237/train - Copy.tsv'
dev_path = '../FB15k-237/dev - Copy.tsv'
test_path = '../FB15k-237/test - Copy.tsv'
# ent_type_path = 'fb13/entities_types.txt'
# tripleid_path = 'fb13/triple_id.txt'
rel2id_path = '../FB15k-237/relations.txt'
ent2text_path = '../FB15k-237/entity2textlong.txt'
...
# with open('../FB15k_237_query2tree/fb15k_237_kg.pkl', 'wb') as file:
#     pickle.dump(G, file)


#load KG from disk
print("Load the KG from disk")
with open('../FB15k_237_query2tree/fb15k_237_kg.pkl', 'rb') as file:
    G = pickle.load(file)
...
# model.wv.save_word2vec_format(f'../FB15k_237_query2tree/fb15k_237_kg_node2vec.wv')
#
#   # Save model for later use
# model.save(f'../FB15k_237_query2tree/fb15k_237_kg_node2vec.model')
# e = time.time()
...
# m = Word2Vec.load('../FB15k_237_query2tree/fb15k_237_kg_node2vec.model')
...
# # k = m.wv
# # print(k)
# with open(f'../FB15k_237_query2tree/fb15k_237_bert_kg_node2vec.pkl', 'wb') as file:
#     pickle.dump(node_embeddings, file)

with open('../FB15k_237_query2tree/fb15k_237_bert_kg_node2vec.pkl', 'rb') as f:
...
# nn = neigh.fit(data)
# with open(f'../FB15k_237_query2tree/fb15k_237_bert_brute.pkl', 'wb') as kdfile:
...
with open('../FB15k_237_query2tree/fb15k_237_bert_brute.pkl', 'rb') as file:
    nn = pickle.load(file)
...
# '''
q2b_path = '../../Q2Bdata/FB15k-237/test_ans_ci.pkl'
...
with open('../FB15k_237_query2tree/fb15k_237_bert_pin.pkl', 'wb') as f:
